  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved practice as @practice" do
        ...
        post :create, {:practice => { "name" => "invalid value" }}, valid_session
        assigns(:practice).should be_a_new(Practice)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested practice" do
        ...
        Practice.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => practice.to_param, :practice => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the practice as @practice" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Practice.any_instance.stub(:save).and_return(false)
        put :update, {:id => practice.to_param, :practice => { "name" => "invalid value" }}, valid_session
        assigns(:practice).should eq(practice)
      end
