  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved visit as @visit" do
        ...
        post :create, {:visit => { "date" => "invalid value" }}, valid_session
        assigns(:visit).should be_a_new(Visit)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested visit" do
        ...
        Visit.any_instance.should_receive(:update_attributes).with({ "date" => "MyString" })
        put :update, {:id => visit.to_param, :visit => { "date" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the visit as @visit" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Visit.any_instance.stub(:save).and_return(false)
        put :update, {:id => visit.to_param, :visit => { "date" => "invalid value" }}, valid_session
        assigns(:visit).should eq(visit)
      end
